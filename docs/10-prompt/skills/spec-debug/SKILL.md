...
2. **View in Proof** (load the `proof` skill) — for easy review and sharing with others
...
2. Document as a learning (`/spec:compound`)
...
4. View in Proof (load the `proof` skill) — for easy review and sharing with others
5. Done
