...
1. 当前 `spec-graph-bootstrap` 已经具备一套 Stage-0 基础事实层、阶段卡片层、文档层、路由层与 runtime context 汇总层
   ...
   - [compile-machine-artifacts.js](../../../src/bootstrap-compiler/compile-machine-artifacts.js)
   - [compile-human-assets.js](../../../src/bootstrap-compiler/compile-human-assets.js)
...
2. `code-review-graph` 的优秀点，不在于“用了图”，而在于它把上下文系统明确拆成：
   ...
   - `code-review-graph/code_review_graph/tools/build.py`
   - `code-review-graph/code_review_graph/prompts.py`
...
1. 收紧 [skills/spec-graph-bootstrap/SKILL.md](../../../skills/spec-graph-bootstrap/SKILL.md)
2. 明确当前主真源是：
