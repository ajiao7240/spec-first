...
**Purpose:** 让读者一次性建立六层地图。
**Visual Content:** Context、Execution、Evidence、Evaluation、Governance、Knowledge 六层，以及核心链路。
...
**Visual Content:** Scripts/Tools、Evidence Packet、LLM/Agents 三段结构。
