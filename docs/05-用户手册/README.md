...
- 一份 GitNexus 刷新策略与 provider 收敛决策，说明官方刷新面、当前刷新节点、最佳实践，以及是否可以删除 code-review-graph
- 可更新、可恢复、可清理的受管资产模型
...
12. [GitNexus 刷新策略与 Provider 收敛决策](./17-GitNexus-刷新策略与Provider收敛决策.md)
13. [常见问题](./04-常见问题.md)
14. [最佳实践](./05-最佳实践.md)
...
- 如果你要判断 GitNexus 刷新最佳实践，或评估是否只保留 GitNexus、删除 code-review-graph，先看 [GitNexus 刷新策略与 Provider 收敛决策](./17-GitNexus-刷新策略与Provider收敛决策.md)
