...
- `docs/solutions/architecture-patterns/workflow-entrypoint-exposure-contract-2026-04-26.md`：保持 standalone skill 与 workflow command 的治理边界，不把宿主差异重新塞回 source skill identity。
