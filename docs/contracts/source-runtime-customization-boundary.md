...
GitNexus, code-review-graph, Serena, browser tools, MCP tools, package managers, and shell commands provide evidence, capabilities, logs, and readiness facts. They do not own semantic authority.
