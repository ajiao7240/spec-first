# spec-bootstrap v2 总体方案

> 本文是 `spec-bootstrap` v2 的主方案文档。
> 它统一收束以下主题：
>
> - 为什么 v1 不够
> - v2 的目标与边界
...
`spec-bootstrap` v2 应从“项目上下文生成”升级为“研发质量资产生成”。
...
> v2 的 `spec-bootstrap` 不是文档生成器，而是研发质量资产生产器。
...
1. `spec-bootstrap-v2-总体方案.md`
2. `spec-bootstrap-v2-演进决策稿.md`
3. `spec-bootstrap-v2-产物清单明细表.md`
4. `spec-bootstrap-v2-worker-任务拆分与PRD模板升级稿.md`
5. `spec-bootstrap-产物文档全览.md`（v1 历史版）
...
`spec-bootstrap` 下一版真正要解决的问题，不是“把现在的文档写得更细”，而是：
