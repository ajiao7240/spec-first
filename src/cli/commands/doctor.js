...
function printHelp() {
  console.log([
    ...
    '',
	    ...
	    '  decision_input_health: currently not_checked; graph/provider readiness lives in setup/bootstrap artifacts.',
	    ...
	    '  MCP/helper setup is handled by $spec-mcp-setup or /spec:mcp-setup.',
	    '  Graph/provider readiness is compiled by $spec-graph-bootstrap or /spec:graph-bootstrap.',
	    '',
	    '🔗 Repository:',
