  ...
  return {
    ...
    decision_inputs: ready
      ? [
          ...
          {
            kind: 'repo_topology',
            decision_input_kind: repoTopology.source === 'artifact' ? 'observed' : 'ambiguous',
            evidence: [repoTopology.source === 'artifact' ? `repo topology: ${repoTopology.kind}` : 'repo-topology.json unavailable'],
          },
        ]
      : [],
