...
- When the user asks to check something → use `agent-browser` to screenshot or inspect the page; if it is missing, ask them to run `/spec:mcp-setup` in Claude or `$spec-mcp-setup` in Codex
