...
Read this file after Phase 2 ideation agents return and the orchestrator has merged, deduped, and synthesized the master candidate list. Do not load before Phase 2 completes.
