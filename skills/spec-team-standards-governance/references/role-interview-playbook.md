...
V2 interviews fill gaps that source code and configs cannot answer. 不要为缺席角色补写答案；missing role input becomes an open question or `not-run`, not inferred policy.
