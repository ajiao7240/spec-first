---
name: spec-plan
description: "Create or deepen structured plans for multi-step work. Use for 'plan this', implementation approach, task breakdowns, trips/study/research plans, or when requirements are ready for planning. Use 'deepen' requests to review and strengthen an existing plan. Prefer spec-brainstorm when the outcome is still unclear."
