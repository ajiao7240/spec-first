...
- **Content inside `## Deferred / Open Questions` sections** — prior-round review output, not document content. This is the spec-doc-review workflow's own staging area
