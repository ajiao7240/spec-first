...
Brainstorming helps answer **WHAT** to build through collaborative dialogue. It precedes the current host's plan entrypoint (`/spec:plan` on Claude Code, `$spec-plan` on Codex), which answers **HOW** to build it.
