...
test -f "$CODEX_PROJECT/.agents/skills/spec-standards/SKILL.md"
...
test -f "$CLAUDE_PROJECT/.claude/commands/spec/standards.md"
...
test -f "$CLAUDE_PROJECT/.claude/spec-first/workflows/spec-standards/SKILL.md"
