...
for file in ideate.md brainstorm.md plan.md work.md debug.md review.md compound.md sessions.md bootstrap.md graph-bootstrap.md mcp-setup.md update.md setup.md; do
