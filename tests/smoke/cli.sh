...
expected_workflow_skill_count="$expected_command_count"
...
for file in ideate.md brainstorm.md plan.md work.md review.md compound.md bootstrap.md graph-bootstrap.md; do
...
for file in ideate.md brainstorm.md plan.md work.md review.md compound.md bootstrap.md graph-bootstrap.md mcp-setup.md; do
...
grep -q '.codex/spec-first/workflows/spec-bootstrap/SKILL.md' "$TMP_DIR/.codex/commands/spec/bootstrap.md"
grep -q '.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md' "$TMP_DIR/.codex/commands/spec/graph-bootstrap.md"
grep -q "Phase 0–4 fact extraction" "$TMP_DIR/.codex/commands/spec/graph-bootstrap.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-brainstorm/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-plan/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-work/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-review/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-compound/SKILL.md"
...
installed_codex_workflow_count="$(find "$TMP_DIR/.codex/spec-first/workflows" -mindepth 1 -maxdepth 1 -type d | wc -l | tr -d ' ')"
test "$installed_codex_workflow_count" = "$expected_workflow_skill_count"
test ! -e "$TMP_DIR/.agents/skills/spec-bootstrap"
test ! -e "$TMP_DIR/.agents/skills/spec-brainstorm"
grep -q '^name: spec-brainstorm$' "$TMP_DIR/.codex/spec-first/workflows/spec-brainstorm/SKILL.md"
grep -q '^name: spec-plan$' "$TMP_DIR/.codex/spec-first/workflows/spec-plan/SKILL.md"
grep -q '^name: spec-work$' "$TMP_DIR/.codex/spec-first/workflows/spec-work/SKILL.md"
grep -q '^name: spec-review$' "$TMP_DIR/.codex/spec-first/workflows/spec-review/SKILL.md"
grep -q '^name: spec-compound$' "$TMP_DIR/.codex/spec-first/workflows/spec-compound/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-bootstrap/SKILL.md"
grep -q '^name: spec-bootstrap$' "$TMP_DIR/.codex/spec-first/workflows/spec-bootstrap/SKILL.md"
test -f "$TMP_DIR/.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md"
grep -q '^name: spec-graph-bootstrap$' "$TMP_DIR/.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md"
grep -q 'fact-inventory.json' "$TMP_DIR/.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md"
grep -q 'backup_<ISO-timestamp>' "$TMP_DIR/.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md"
grep -q '成功后删除 backup 目录' "$TMP_DIR/.codex/spec-first/workflows/spec-graph-bootstrap/SKILL.md"
...
test ! -e "$TMP_DIR/.codex/spec-first/workflows/spec-brainstorm/SKILL.md"
test ! -e "$TMP_DIR/.codex/spec-first/workflows"
test ! -e "$TMP_DIR/.codex/commands/spec/graph-bootstrap.md"
