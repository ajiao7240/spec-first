...
grep -q '阶段 1 安装集成期' "$TMP_DIR/.claude/skills/spec-graph-bootstrap/SKILL.md"
grep -q 'spec-bootstrap` 仍然是默认稳定入口' "$TMP_DIR/.claude/skills/spec-graph-bootstrap/SKILL.md"
...
grep -q '阶段 1 安装集成期' "$TMP_DIR/.agents/skills/spec-graph-bootstrap/SKILL.md"
