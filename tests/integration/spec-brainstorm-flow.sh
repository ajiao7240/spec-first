...
grep -q 'Restated Understanding' "skills/spec-brainstorm/SKILL.md"
grep -q 'Verification-as-Done' "skills/spec-brainstorm/SKILL.md"
...
grep -q '### Lightweight Planning Anchor' "skills/spec-plan/SKILL.md"
grep -q '### Reload Before Act' "skills/spec-plan/SKILL.md"
grep -q 'freshness_stale' "skills/spec-plan/SKILL.md"
