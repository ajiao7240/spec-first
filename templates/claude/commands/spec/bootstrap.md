...
Before doing anything else, read `.claude/skills/spec-bootstrap/SKILL.md` and execute that workflow as the primary contract for this command.

Rules:
- Treat `.claude/skills/spec-bootstrap/SKILL.md` as the source of truth for phase execution, artifact paths, and handoff behavior.
