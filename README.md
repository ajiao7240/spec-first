...
- Dirty refresh blocked means provider index refresh is blocked, not that stale/advisory GitNexus query evidence is unusable for read-only orientation. Dirty-path conclusions still need direct source reads before final claims.
