...
Note that files in `docs/plans/` and `docs/solutions/` are spec-first pipeline artifacts created by `/spec:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
