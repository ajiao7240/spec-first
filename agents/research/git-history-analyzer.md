...
Note that files in `docs/plans/` and `docs/solutions/` are long-lived planning and knowledge artifacts maintained by the project's workflow. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
