...
Use the shared anchored rubric (see `skills/spec-doc-review/references/subagent-template.md` — Confidence rubric). Scope-guardian's domain grounds in the document's own stated goals and declared scope. Apply as:
...
- Missing requirements (spec-coherence-reviewer), security (spec-security-lens-reviewer)
- Design/UX (spec-design-lens-reviewer), technical feasibility (spec-feasibility-reviewer)
