---
name: spec-schema-drift-detector
...
- Run `spec-schema-drift-detector` first to ensure clean schema
- Then run `spec-data-migration-expert` for migration logic review
- Then run `spec-data-integrity-guardian` for integrity checks
