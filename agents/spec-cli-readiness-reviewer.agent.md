---
name: spec-cli-readiness-reviewer
...
- **Agent-native parity concerns** -- whether UI actions have corresponding agent tools. That is the spec-agent-native-reviewer's domain, not yours.
