...
Use the shared anchored rubric (see `skills/spec-doc-review/references/subagent-template.md` — Confidence rubric). Design-lens's domain grounds in named interaction states and user flows. Apply as:
