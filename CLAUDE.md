...
This project is indexed by GitNexus as **spec-first** (20076 symbols, 22655 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
