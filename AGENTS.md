...
This project is indexed by GitNexus as **spec-first** (20004 symbols, 22577 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
