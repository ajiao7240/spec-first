...
This project is indexed by GitNexus as **spec-first** (20137 symbols, 22718 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
