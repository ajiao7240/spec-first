...
This project is indexed by GitNexus as **spec-first** (19634 symbols, 22148 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
